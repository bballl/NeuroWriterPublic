...
namespace GameBoxProject
{
    ...
    public class TextRendererParticleSystem : MonoBehaviour
    {
        ...
        #region =====================================================================УДАЛИТЬ СРАЗУ ПОСЛЕ ТЕСТОВ
        ...
        {
            int damage = UnityEngine.Random.Range(0, 250);
            float greenColor = (255f - damage)/255f;
            Color color = new Color(1f, greenColor, 0f);
            Debug.Log($"Color: r-{color.r}, g-{color.g}, b-{color.b}");

            SpawnParticle(transform.position, -damage, color, 0.8f);
        }
